...
function canonicalPreviewConfiguration(
  ...
  return compact({
    ...
    agentBrowserAccess: booleanValue(
      previewValueOrPrevious(raw, previous, 'agentBrowserAccess', 'agentBrowserAccess'),
    ),
    agentBrowserInteraction: booleanValue(
      previewValueOrPrevious(raw, previous, 'agentBrowserInteraction', 'agentBrowserInteraction'),
    ),
