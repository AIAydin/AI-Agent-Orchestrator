...
export const ProjectVideoChooseInputSchema = z
  .object({ projectId: ProjectFileIdSchema })
  .strict();
export type ProjectVideoChooseInput = z.infer<
  typeof ProjectVideoChooseInputSchema
>;
...
const ProjectVideoAvailableSchema = z
  .object({
    ...
    playbackUrl: z
      .string()
      .regex(/^forgeboard-video:\/\/media\/[0-9a-f-]{36}$/u),
...
export type ProjectVideoLoadResult = z.infer<
  typeof ProjectVideoLoadResultSchema
>;
