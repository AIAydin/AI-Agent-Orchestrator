...
export const HELP_ARTICLES: readonly HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Save, then check that the provider shows Ready. Your sign-in with that provider stays between you and them — Forgeboard does not manage it.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Sharing with other people and app-update options stay off unless the feature they belong to is available and you have reviewed it.',
    ],
  },
  {
