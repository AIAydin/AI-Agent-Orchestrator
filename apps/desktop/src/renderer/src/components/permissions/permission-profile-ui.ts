...
export const PERMISSION_PROFILE_OPTIONS: readonly {
...
}[] = [
  {
    ...
    description: "The agent can read your project and suggest a plan, but can't change any files.",
  },
  {
  ...
  },
  {
    value: 'custom',
    label: 'Custom',
    description: 'Choose exactly what the agent can access. Set the details in Settings.',
  },
] as const;
