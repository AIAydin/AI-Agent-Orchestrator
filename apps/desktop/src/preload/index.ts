...
const api: ForgeboardApi = {
  ...
  browserCompanion: {
    open: (input) =>
      invokeValidated(BROWSER_COMPANION_IPC_CHANNELS.open, BrowserCompanionStatusSchema, input),
    status: (input) =>
      invokeValidated(BROWSER_COMPANION_IPC_CHANNELS.status, BrowserCompanionStatusSchema, input),
    focus: (input) =>
      invokeValidated(BROWSER_COMPANION_IPC_CHANNELS.focus, BrowserCompanionStatusSchema, input),
    close: (input) =>
      invokeValidated(BROWSER_COMPANION_IPC_CHANNELS.close, BrowserCompanionStatusSchema, input),
    clear: (input) =>
      invokeValidated(BROWSER_COMPANION_IPC_CHANNELS.clear, BrowserCompanionStatusSchema, input),
    snapshot: (input) =>
      invokeValidated(
    ...
    navigate: (input) => invokeValidated(BROWSER_COMPANION_IPC_CHANNELS.navigate, z.null(), input),
  },
  checks: {
