...
import { readValidatedLocalDataImportFile } from './recovery/import-file.js';
...
export class RecoveryIpcService {
  ...
  #assertLiveSender(event: IpcMainInvokeEvent): void {
    ...
    if (event.senderFrame !== event.sender.mainFrame) {
      throw new Error('Recovery operations are allowed only from the main Forgeboard frame.');
    }
  }
